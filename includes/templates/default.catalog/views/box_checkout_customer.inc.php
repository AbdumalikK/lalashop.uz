<section id="box-checkout-customer" class="box">
  ...
  <div>
    <button class="btn btn-block btn-default mt-4" name="save_customer_details" type="submit" disabled="disabled"><?php echo language::translate('title_save_changes', 'Save Changes'); ?></button>
  </div>
